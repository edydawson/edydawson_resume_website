...
function displayFromLocalStorage(key, value, typevalue) {
  ...
  // assign each value to a column name
   ...
   if(typevalue == "Keynote") {
      ...
      dk.innerHTML = "<p><strong>" + name + "</strong><br />&nbsp;&nbsp;&nbsp;Speaker(s): " + updatedSpeakers + "<br />&nbsp;&nbsp;&nbsp;Room: " + updatedVenues + "</p>";
      document.getElementById("keynote").appendChild(dk);
   }
   else if(typevalue == "40-minute Session") {
      var ds = document.createElement('div');
      document.body.appendChild(ds);
      ds.class="tablist-content";
      ds.innerHTML = "<p><strong>" + name + "</strong><br />&nbsp;&nbsp;&nbsp;Speaker(s): " + updatedSpeakers + "<br />&nbsp;&nbsp;&nbsp;Room: " + updatedVenues + "</p>";
      ...
      dt.innerHTML = "<p><strong>" + name + "</strong><br />&nbsp;&nbsp;&nbsp;Speaker(s): " + updatedSpeakers + "<br />&nbsp;&nbsp;&nbsp;Room: " + updatedVenues + "</p>";
      document.getElementById("tutorial").appendChild(dt);
   }
   else if(typevalue == "Author Signing") {
      var da = document.createElement('div');
      document.body.appendChild(da);
      da.class="tablist-content";
      da.innerHTML = "<p><strong>" + name + "</strong><br />&nbsp;&nbsp;&nbsp;Room: " + updatedVenues + "</p>";
      document.getElementById("session").appendChild(da);
   }
   else if(typevalue == "Office Hour") {
      var dh = document.createElement('div');
      document.body.appendChild(dh);
      dh.class="tablist-content";
      dh.innerHTML = "<p><strong>" + name + "</strong><br />&nbsp;&nbsp;&nbsp;Speaker(s): " + updatedSpeakers + "<br />&nbsp;&nbsp;&nbsp;Room: " + updatedVenues + "</p>";
      document.getElementById("tutorial").appendChild(dh);
   } 
   else {
